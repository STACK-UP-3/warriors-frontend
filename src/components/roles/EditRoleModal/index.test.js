...
import EditRoleModal from './index';

const initialise = (props = {}) => {
  const component = shallow(<EditRoleModal {...props} />);
  return component;
};
...
describe('>>> Testing the Edit Role modal component', () => {
  let component;
  let fnMock;
  ...
  describe('Validate component PropTypes', () => {
    it('should accept valid props', () => {
      const validProps = {
        ...
        fnUpdateRole: jest.fn(),
      };

      const propsErr = checkProps(EditRoleModal, validProps);
  ...
  describe('Validate component Events', () => {
    ...
    it('should successfully call a function on submit event', () => {
      const form = findNodeByTestAttr(component, 'form--edit-role');
